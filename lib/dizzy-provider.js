...
module.exports = (path, requireFn) => {
    ...
    class DizzyProvider {
        ...
        cached(newSetting) {
            ...
            if (newSetting) {
                this.provide = () => {
                    ...
                    if (isResolvingAsync) {
                        throw new Error(`Can not provide synchronously while being provided asynchronously: ${this.key}`);
                    }
                ...
                this.provideAsync = () => {
                    return new Promise((resolve) => {
                        if (isCached) {
                            ...
                            resolve(this.resolveAsync().then((val) => {
                                isCached = true;
                                cachedValue = val;
                ...
                this.provideAsync = this.resolveAsync;
            }
        ...
        fromModule(baseDir) {
            ...
            function fromFn() {
                try {
                    ...
                    throw new Error("Error requiring " + realRequire + ": " + e.toString());
                }
            }
         ...
         */
        resetCache() {
            // this.provide may not exist.  If it doesn't then we are
            // still during object creation.
            //
            // this.provide !== this.resolve only if caching is enabled.
            if (this.provide && this.provide !== this.resolve) {
                this.cached();
            }
        }
