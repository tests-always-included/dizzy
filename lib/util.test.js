...
test('determineArgs() parses an async function', t => {
    t.deepEqual(mockToString('async function(a){'), ['a']);
});

test('determineArgs() parses an async arrow function with parentheis', t => {
    t.deepEqual(mockToString('async (a)=>{'), ['a']);
});

test('determineArgs() parses an async arrow function without parenthesis', t => {
    t.deepEqual(mockToString('async (a)=>{'), ['a']);
});
